...
```bash
python app/select_fcpxml_remediation.py output/sample_fcpxml_compatibility_review.json output/sample_fcpxml_remediation_selection.json --remediation-id r001 --selected-by module13-reviewer --selected-at 2026-07-04T02:10:00+00:00 --selection-reason "Select the highest-priority evidence-backed remediation for the next reviewed implementation module."
```
